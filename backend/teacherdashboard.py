...
if 'students' not in st.session_state:
    st.session_state.students = [
        {"id": 1, "name": "Alice Johnson", "age": 21, "course": "Computer Science", "math": 85, "science": 92, "history": 78, "english": 88},
        {"id": 2, "name": "Bob Smith", "age": 21, "course": "Mechanical", "math": 72, "science": 68, "history": 85, "english": 79},
        {"id": 3, "name": "Charlie Green", "age": 20, "course": "Electrical", "math": 91, "science": 94, "history": 89, "english": 93},
    ]
# ----- Helper functions -----
